...
int main() {
	...
	cout << "Samuel Tran -- CSIS 215 Programming Assignment 1 -- Bag Dictionary" << endl << endl;
	...
	KVpair<int, string> keyval (7,"seven");
	KVpair<int, string> inspectVar;
	
	//implementation of +=
	if ((myBag+=(keyval)) == true)
	{
		cout << "+= function was successful it was : " << keyval.key() << ", " << keyval.value() <<endl; 
	}

	//implementation of inspectTop in ABag
	if (myBag.inspectTop(inspectVar))
	{
		cout << "inspectTop was successful the value is: " << inspectVar.key() << ", " << inspectVar.value() << endl;
	}
	cout << "The bag capacity for myBag is: " << myBag.bagCapacity() << endl;
	//implementation of smart pointer from https://learn.microsoft.com/en-us/cpp/cpp/smart-pointers-modern-cpp?view=msvc-170
	unique_ptr<string> smartPtr(new string("This is a smart pointer"));
	cout << "Example of utilization of smart pointer with its memory address: " << smartPtr<<endl <<"Along with its value: " << *smartPtr << endl;
